...
本项目参与 [LINUX DO](https://linux.do/) 开源推广，项目主页已添加 LINUX DO 和 [NodeSeek](https://www.nodeseek.com/) 友链。

- [x] 项目代码公开可访问。
- [x] README 已提供安装方式、功能说明和界面截图。
- [x] README 已添加 [LINUX DO](https://linux.do/) 和 [NodeSeek](https://www.nodeseek.com/) 友链。
